...
INCLUDE   = -I./include -framework SDL2 -framework Cocoa -I/Library/Frameworks/SDL2.framework/Headers/ -I/Library/Frameworks/SDL2_ttf.framework/Headers/ -I/usr/local/include/freetype2/ -I/usr/local/opt/bzip2/include  -I/usr/local/opt/sdl2_image/include/SDL2/
TARGET    = ./bin.out
SRCDIR    = ./
ifeq "$(strip $(SRCDIR))" ""
  SRCDIR  = .
